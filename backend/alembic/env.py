...
Reads DATABASE_URL from the environment (via .env) and wires
...
import app.db.models  # noqa: F401, E402  (side-effect import)

# ── Alembic Config object ───────────────────────────────────────────────
config = context.config

# Inject DATABASE_URL from environment into alembic.ini interpolation
